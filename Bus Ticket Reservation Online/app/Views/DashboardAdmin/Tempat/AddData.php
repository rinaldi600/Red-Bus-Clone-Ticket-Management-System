...
<div class="form-addData">
    ...
    <h1 class="mb-3">Tambah Data Tempat</h1>
    <form action="/DashboardTempat/addTempat" method="post">
        <div class="mb-3 form-floating">
            <textarea class="form-control <?= session()->getFlashdata('asal') ? 'is-invalid' : ( session()->getFlashdata('samePlace') ? 'is-invalid' : ( old('asal') ? 'is-valid' : '')) ?>" placeholder="Masukkan Asal Tempat" name="asal" id="floatingTextarea2" style="height: 100px"><?= old('asal') ? old('asal') : '' ?></textarea>
        ...
        <div class="mb-3 form-floating">
            <textarea class="form-control <?= session()->getFlashdata('tujuan') ? 'is-invalid' : ( session()->getFlashdata('samePlace') ? 'is-invalid' : ( old('tujuan') ? 'is-valid' : '')) ?>" placeholder="Masukkan Tempat Tujuan" name="tujuan" id="floatingTextarea2" style="height: 100px"><?= old('tujuan') ? old('tujuan') : '' ?></textarea>
