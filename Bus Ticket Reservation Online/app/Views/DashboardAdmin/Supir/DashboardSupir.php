...
<div class="list-supir">

    <a class="btn btn-outline-secondary mb-3 text-dark" href="/DashboardSupir/addSupirView">
        Tambah Data
    ...
    <form action="/DashboardSupir" method="get">
    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
            <?php foreach ($listSupir as $supir) { ?>
                <tr class="text-center">
                    <th scope="row"><?= $number++ ?></th>
                    <td><?= $supir["nama"] ?></td>
                    <td><?= $supir["handphone"] ?></td>
                    <td><?= $supir["alamat"] ?></td>
                    ...
                    <td class="d-grid justify-content-center">
                        <ul class="d-flex gap-2">
                            <li>
                                <form action="/DashboardSupir/editSupirView" method="get">
                                    <input type="hidden" name="idSupir" value="<?= $supir["idSupir"] ?>">
                            ...
                            <li>
                                <input type="hidden" name="idSupir" value="<?= $supir["idSupir"] ?>">
                                <button class="on-delete" type="submit">
    ...
    <div class="page-pagination d-grid justify-content-center mt-3">
        <?= $pager->links('supir','custom_pagination') ?>
    </div>
</div>
