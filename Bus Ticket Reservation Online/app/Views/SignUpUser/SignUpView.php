    ...
    <?php if (session()->getFlashdata("success")) { ?>
        <div class="success">
            <div class="text-center notifications alert alert-success position-absolute top-50 start-50 translate-middle" role="alert">
                <?= session()->getFlashdata("success") ?> <a class="text-decoration-none" href="/loginUser">Login</a>
            </div>
        </div>
    <?php } ?>

    <h1 class="text-center title-signup">Form Pendaftaran User Ticket</h1>
    <form action="/SignUpUser/signup" method="post">
        <div class="form-signup row">
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                ...
                <a href="/LoginUser" class="btn btn-outline-success">Back</a>
            </div>
        </div>
    </form>
</div>
